...
class x {
  ...
  private static function errorMessage($code) {
    switch( $code ) {
      ...
      case self::ERROR_NOT_YOUR_ID : $msg = "The account that you are trying to edit is not yours. The page that you are seeing right now is your own account page"; break;      
